...
epicsEnvSet("LOCATION", "PLC:Motion" )
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:Motion:")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:Motion")
dbLoadRecords("save_restoreStatus.db", "P=PLC:Motion:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:Motion")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:Motion")
...
save_restoreSet_status_prefix( "PLC:Motion:" )
